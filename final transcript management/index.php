...
<div class="container">
  ...
  <h2 style="text-align:center;margin-left:50px; margin-top:-70px; color:#000040;">National Institute of Technology, Tiruchirappalli-15</h2>
 
    <!-- end .header --></div>
  <div class="content">
    <!--<h1>Instructions</h1>-->
    <center><h3 style="color:#000040;">TRANSCRIPT SECTION</h3></center>
    <center>
    <div class="rain">
			<div class="border start">
				<form id="form1" name="form1" method="post" action="loginvalidate.php">
					<label for="email">Webmail Id</label>
					<input  type="text" placeholder="Webmail Id" name="id" id="id" required/>
					<label for="pass">Password</label>
					<input  type="password" placeholder=" Webmail Password" name="pass" id="pass" required/>
                                        <input type="submit" value="LOG IN"/>
				</form>
			</div>
               <?php
		
				if(isset($_SESSION['success']) && isset($_SESSION['success']) =='nok')
				{
				echo "<h4 style=\"color:#000040;\">Wrong Username or password</h4>";
				}
