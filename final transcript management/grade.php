...
function display()
{
	...
	if(document.getElementById("fee").value == "Grade card")
	{
		document.getElementById("fee1").value =30;
		document.getElementById("tot1").value=30;
	}
	else if(document.getElementById("fee").value == "Grade card (additional)")
	{
		document.getElementById("fee1").value = 10;
		document.getElementById("tot1").value = 10;
	}
...
<div class="container">
  ...
  <div class="content">
    <!--<h1>Instructions</h1>-->
    <center>
	<h3>Application Form For Grade Card</h3>
    <form action="grade_reg.php" method="post">
    <table>
    <tr>
    <td>Name</td>
    ...
    <td><select onchange="display();" id="fee" name="fee">
    	<option>Select</option>
            ...
            <option value="Grade card (additional)">Grade card (additional)</option>
             </select>
    </td>
    </tr>
    <tr>
