...
function display()
{
	...
	if(document.getElementById("fee").value == "Duplicate ID card")
	{
		document.getElementById("fee1").value =100;
		document.getElementById("tot1").value=100;
	}
...
<div class="container">
  ...
  <div class="content">
    <!--<h1>Instructions</h1>-->
    <center>
	<h3>Application Form For Duplicate Id Card</h3>
    <form action="dupid_reg.php" method="post">
    <table>
    <tr>
    <td>Name</td>
